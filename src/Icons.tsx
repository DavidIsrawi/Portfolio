...
function handleKeyboardNavigation(event: React.KeyboardEvent, link: string): void {
    if (event.key === 'Enter') {
        openInNewTab(link)
    }
}

export function LightThemeIcon(): JSX.Element {
    return (
...
export function DarkThemeIcon(): JSX.Element {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:fill-current" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function SocialIcon(props: SocialIconProps): JSX.Element {
    return (
        <div
            className="w-6 fill-current cursor-pointer transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-103 focus:-translate-y-1 focus:scale-103"
            onClick={() => openInNewTab(props.link)}
            tabIndex={0}
            onKeyUp={(event) => handleKeyboardNavigation(event, props.link)}
            role="link"
        >
            {props.children}
        </div>
...
function TwitchIcon(): JSX.Element {
    return (
        <SocialIcon link="https://www.twitch.tv/dahveed_iy">
...
function TwitterIcon(): JSX.Element {
    return (
        <SocialIcon link="https://twitter.com/DavidIsrawi">
...
function GithubIcon(): JSX.Element {
    return (
        <SocialIcon link="https://github.com/DavidIsrawi">
...
function InstagramIcon(): JSX.Element {
    return (
        <SocialIcon link="https://www.instagram.com/davidisrawi/">
...
function LinkedInIcon(): JSX.Element {
    return (
        <SocialIcon link="https://www.linkedin.com/in/davidisrawi/">
...
function ResumeIcon(): JSX.Element {
    return (
        <SocialIcon link={userProfile.resume}>
...
export function SocialMediaIcons(): JSX.Element {
    return (
