...
export const TravelContainer = () => {
    ...
    return (
        <section className='mx-auto w-2/3 items-center' id="Travel">
            ...
            <p>I like to make Google Maps lists of places I have visited, mostly documenting which places are worth visiting for food and for the experience. Feel free to use these lists for your own traveling.</p>
            {
...
const MapsListCard = (props: MapsListCardProps) => {
    return (
        <div className='bg-[url("../public/assets/Maps.png")] text-primary m-2 py-4 px-6 rounded-full transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-103 focus:-translate-y-1 focus:scale-103 self-center text-center'>
